...
category_bindings = {
    ...
    ('Desporto', 'Esportes', 'Euro 2004', 'Euro2016', 'Resultados', 'Relvado', 'Futebol', 'Mundial2010', 'Mundial',
     ...
     'Futebol Nacional', 'Futebol Internacional', 'Outras Modalidades', 'Motores', 'Modalidades Outras',
     'Bola Branca', 'Fut Nacional', 'Modalidades', 'Fut Internacional'): Category.SPORTS,
    ...
    ('Local', 'Local Lisboa', 'Grande Porto', 'Grande Lisboa', 'Grande Lsiboa', 'Porto 2001', 'Regional', 'Lisboa',
     'Local e regional', 'Porto', 'Regiões'): Category.LOCAL,
